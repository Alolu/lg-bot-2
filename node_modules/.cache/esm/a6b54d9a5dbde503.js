"main";let ModuleClass;_5db‍.w("components/module",[["default",["ModuleClass"],function(v){ModuleClass=v}]]);const fs = require('fs');
...
class Commands {
    ...
    async init_modules(){
        this.moduleList.forEach((Module,key)=>{
            _5db‍.g.console.log('foreach 2 : ', key)
        ...
        _5db‍.g.console.log(bot.modules);
    }
