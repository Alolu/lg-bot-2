"main";let ModuleClass;_227‍.w("components/module",[["default",["ModuleClass"],function(v){ModuleClass=v}]]);const fs = require('fs');
...
class Commands {
    ...
    CheckIfModuleIn(moduleFolder){
        try {
            _227‍.g.console.log('fzeffez',path.join('..',this.plugin_dir,moduleFolder,bot.moduleFile))
            Module = require(path.join(this.plugin_dir,moduleFolder,bot.moduleFile))
            return Module
        }
        catch (err) {
            _227‍.g.console.log(err)
            return false
        }
    }
