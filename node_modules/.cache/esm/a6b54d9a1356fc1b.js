"main";let ModuleClass;_135‍.w("components/module",[["default",["ModuleClass"],function(v){ModuleClass=v}]]);const fs = require('fs');
...
class Commands {
    ...
    CheckIfModuleIn(moduleFolder){
        try {
            _135‍.g.console.log(require(path.join(this.plugin_dir,moduleFolder,bot.moduleFile)))
        }
        catch (err) {
