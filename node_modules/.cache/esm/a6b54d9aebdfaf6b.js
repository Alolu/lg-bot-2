"main";let ModuleClass;_ebd‍.w("components/module",[["default",["ModuleClass"],function(v){ModuleClass=v}]]);const fs = require('fs');
...
class Commands {
    ...
    CheckIfModuleIn(moduleFolder){
        try {
            ...
            _ebd‍.g.console.log("File not found : " + err)
            return false
        }
    }
