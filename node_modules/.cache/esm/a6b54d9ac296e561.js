"main";let ModuleClass;_c29‍.w("components/module",[["default",["ModuleClass"],function(v){ModuleClass=v}]]);const fs = require('fs');
...
class Commands {
    ...
    CheckIfModuleIn(moduleFolder){
        try {
            _c29‍.g.console.log('fzeffez',path.join('..',this.plugin_dir,moduleFolder,bot.moduleFile))
            Module = require(path.join(this.plugin_dir,moduleFolder,bot.moduleFile,'fezf'))
            return Module
        }
        catch (err) {
            _c29‍.g.console.log(err)
            return false
        }
    }
