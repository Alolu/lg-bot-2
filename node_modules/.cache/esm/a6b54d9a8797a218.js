"main";_879‍.x([["default",()=>Commands]]);let ModuleClass;_879‍.w("components/module",[["default",["ModuleClass"],function(v){ModuleClass=v}]]);const fs = require('fs');
...
//! Ajouter un module pour ameliorer les Import aussi ou utiliser un workaround a voir.
    ...
    CheckIfModuleIn(moduleFolder){
        try {
            ...
            var Module = _879‍.i(path.join(this.plugin_dir,moduleFolder,bot.moduleFile))
            return Module
        }
        catch (err) {
            _879‍.g.console.log(err)
            return false
        }
    }
    //! A FIX SOON
    async init_modules(){
        ...
        _879‍.g.console.log(bot.commands)
        this.commandCount
