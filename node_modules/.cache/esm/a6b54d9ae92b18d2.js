"main";let ModuleClass;_e92‍.w("components/module",[["default",["ModuleClass"],function(v){ModuleClass=v}]]);const fs = require('fs');
...
class Commands {
    ...
    load_commands(){
        _e92‍.g.console.log('Loading modules...')
        this.plugin_folders = this.getDirectories(path.join('.',this.plugin_dir));
        this.preload_modules()
        this.init_modules()
        _e92‍.g.console.log('All modules loaded.')
    }

    preload_modules(){
        this.plugin_folders.forEach((moduleFolder)=>{
    ...
    CheckIfModuleIn(moduleFolder){
        try {
            _e92‍.g.console.log('fzeffez',path.join('..',this.plugin_dir,moduleFolder,bot.moduleFile))
            Module = require(path.join(this.plugin_dir,moduleFolder,bot.moduleFile) + '.js')
            return Module
        }
        catch (err) {
            _e92‍.g.console.log("File not found : " + err)
            return false
        }
    }
    ...
    init_modules(){
        this.moduleList.forEach((Module,key)=>{
            ...
            Module.setBot(bot)
            bot.commands.concat(module.getCommands())
