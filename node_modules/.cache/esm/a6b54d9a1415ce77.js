"main";_141‍.x([["default",()=>Commands]]);let ModuleClass;_141‍.w("components/module",[["default",["ModuleClass"],function(v){ModuleClass=v}]]);const fs = require('fs');
...
//! Ajouter un module pour ameliorer les Import aussi ou utiliser un workaround a voir.
    ...
    async CheckIfModuleIn(moduleFolder){
        try {
            ...
            var Module = await _141‍.i(path.join(this.plugin_dir,moduleFolder,bot.moduleFile))
            return Module
        }
        catch (err) {
            _141‍.g.console.log(err)
            return false
        }
    }
    //! A FIX SOON
    async init_modules(){
        ...
        _141‍.g.console.log(bot.commands)
        this.commandCount
