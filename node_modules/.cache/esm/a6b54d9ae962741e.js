"main";let ModuleClass;_e96‍.w("components/module",[["default",["ModuleClass"],function(v){ModuleClass=v}]]);const fs = require('fs');
...
class Commands {
    ...
    CheckIfModuleIn(moduleFolder){
        try {
            _e96‍.g.console.log('fzeffez',path.join(this.plugin_dir,moduleFolder,bot.moduleFile))
            Module = require(path.join(this.plugin_dir,moduleFolder,bot.moduleFile))
            return Module
        }
        catch (err) {
            _e96‍.g.console.log("File not found : " + err)
            return false
        }
    }
