"main";let ModuleClass;_415‍.w("components/module",[["default",["ModuleClass"],function(v){ModuleClass=v}]]);const fs = require('fs');
...
class Commands {
    ...
    load_commands(){
        _415‍.g.console.log('Loading modules...')
        this.plugin_folders = this.getDirectories(path.join('.',this.plugin_dir));
        _415‍.g.console.log(this.plugin_folders)
        this.preload_modules()
        this.init_modules()
        _415‍.g.console.log('All modules loaded.')
    }
    ...
    CheckIfModuleIn(moduleFolder){
        try {
            ...
            _415‍.g.console.log("File not found : " + err)
            return false
        }
    }
