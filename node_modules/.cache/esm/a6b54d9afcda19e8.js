"main";_fcd‍.x([["default",()=>Commands]]);let ModuleClass;_fcd‍.w("components/module",[["default",["ModuleClass"],function(v){ModuleClass=v}]]);const fs = require('fs');
...
//! Ajouter un module pour ameliorer les Import aussi ou utiliser un workaround a voir.
    ...
    async CheckIfModuleIn(moduleFolder){
        try {
            ...
            var Module = _fcd‍.i(path.join(this.plugin_dir,moduleFolder,bot.moduleFile))
            return Module
        }
        catch (err) {
            _fcd‍.g.console.log(err)
            return false
        }
    }
    //! A FIX SOON
    async init_modules(){
        ...
        _fcd‍.g.console.log(bot.commands)
        this.commandCount
