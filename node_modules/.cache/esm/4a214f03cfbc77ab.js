"main";let Commands;_cfb‍.w("./components/commands",[["default",["Commands"],function(v){Commands=v}]]);//INIT
//Node Modules
...
bot.on('ready', function(){
    _cfb‍.g.console.log("Initialisation starting...");
    bot.commandManager.load_commands();
    _cfb‍.g.console.log("All commands loaded");

    bot.user.setActivity(bot.prefix + 'help');

    _cfb‍.g.console.log(botName + " is now on.");
})
bot.on('message',(msg) => {
