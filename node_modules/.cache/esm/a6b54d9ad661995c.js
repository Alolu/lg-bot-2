"main";let ModuleClass;_d66‍.w("components/module",[["default",["ModuleClass"],function(v){ModuleClass=v}]]);const fs = require('fs');
...
class Commands {
    ...
    CheckIfModuleIn(moduleFolder){
        try {
            require(path.join(this.plugin_dir,moduleFolder,bot.moduleFile))
        }
        catch (err) {
            _d66‍.g.console.log(err)
            return false
        }
    }
