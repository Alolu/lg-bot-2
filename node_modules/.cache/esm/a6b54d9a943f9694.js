"main";_943‍.x([["default",()=>Commands]]);let ModuleClass;_943‍.w("components/module",[["default",["ModuleClass"],function(v){ModuleClass=v}]]);const fs = require('fs');
...
//! Ajouter un module pour ameliorer les Import aussi ou utiliser un workaround a voir.
    ...
    async CheckIfModuleIn(moduleFolder){
        try {
            ...
            var Module = await _943‍.i(path.join(this.plugin_dir,moduleFolder,bot.moduleFile))
            return Module.default
        }
        catch (err) {
            _943‍.g.console.log(err)
            return false
        }
    }
